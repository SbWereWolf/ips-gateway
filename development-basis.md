...
будет получен ожидаемый текстовый результат.
...
- получить аргументы запуска
- получить текстовый ввод из командной строки
- создать экземпляр класса обработчика
- применить к экземпляру настройки
- выполнить обработку с помощью экземпляра
...
проишествий (аварий в работе ПО), его запись это критичный функционал,
